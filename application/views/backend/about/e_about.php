    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="form-group mb-2">
                    <label> Judul About</label><br>
                    <input type="text" name="judul_about" value="<?= $about['judul_about'];?>" class="form-control" required>
                </div>

                <div class="form-group mb-2">
                    <label> Deskripsi About</label><br>
                   <textarea name="deskripsi_about" class="form-control" cols="30" rows="6" required> <?= $about ['deskripsi_about']; ?></textarea>
                </div>

                <div class="form-group mb-2">
                    <label> Gambar About</label><br>

    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="form-group">
                   <textarea name="alamat_konsumen" class="form-control" cols="30" rows="5" placeholder="Input Alamat Konsumen" required></textarea>
                    
                </div>

                <div class="form-group">
                    <input type="text" name="no_telepon" class="form-control"placeholder="Input No.Telepon  Konsumen" required>
